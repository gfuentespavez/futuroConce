...
export const topics = [
    { id: 'population', label: 'Población y Género', icon: '👥' },
    { id: 'age-pyramid', label: 'Grupos de Edad', icon: '📊' },
    { id: 'employment', label: 'Empleo', icon: '💼' },
    { id: 'literacy', label: 'Alfabetización', icon: '📚' },
    { id: 'housing', label: 'Vivienda', icon: '🏠' },
    { id: 'households', label: 'Hogares', icon: '👨‍👩‍👧‍👦' }
];
